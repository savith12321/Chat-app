/*! markdown-it 8.2.2 https://github.com//markdown-it/markdown-it @license MIT */ ! function(e) {
    ...
    return function e(r, t, n) {
        ...
        4: [function(e, r, t) {
            ...
            var y = Object.prototype.hasOwnProperty,
                ...
                F = /[.?*+^$[\]\\(){}|-]/g,
                L = e("uc.micro/categories/P/regex");
        ...
        10: [function(e, r, t) {
            ...
            n.prototype.tokenize = function(e, r, t) {
                for (var n, s, o = this.ruler.getRules(""), i = o.length, a = r, c = !1, l = e.md.options.maxNesting; a < t && (e.line = a = e.skipEmptyLines(a), !(a >= t)) && !(e.sCount[a] < e.blkIndent);) {
                    ...
                    e.tight = !c, e.isEmpty(e.line - 1) && (c = !0), a = e.line, a < t && e.isEmpty(a) && (c = !0, a++, e.line = a)
                }
        ...
        18: [function(e, r, t) {
            ...
            r.exports = function(e, r, t, s) {
                var o, i, a, c, l, u, p, h, f, d, m, _, g, b, k, v, y, x, C, A = e.bMarks[r] + e.tShift[r],
                    w = e.eMarks[r];
                if (62 !== e.src.charCodeAt(A++)) return !1;
                if (s) return !0;
                for (_ = e.blkIndent, e.blkIndent = 0, c = f = e.sCount[r] + A - (e.bMarks[r] + e.tShift[r]), 32 === e.src.charCodeAt(A) ? (A++, c++, f++, o = !1, v = !0) : 9 === e.src.charCodeAt(A) ? (v = !0, (e.bsCount[r] + f) % 4 === 3 ? (A++, c++, f++, o = !1) : o = !0) : v = !1, d = [e.bMarks[r]], e.bMarks[r] = A; A < w && (i = e.src.charCodeAt(A), n(i));) 9 === i ? f += 4 - (f + e.bsCount[r] + (o ? 1 : 0)) % 4 : f++, A++;
                for (m = [e.bsCount[r]], e.bsCount[r] = e.sCount[r] + 1 + (v ? 1 : 0), u = A >= w, b = [e.sCount[r]], e.sCount[r] = f - c, k = [e.tShift[r]], e.tShift[r] = A - e.bMarks[r], x = e.md.block.ruler.getRules("blockquote"), g = e.parentType, e.parentType = "blockquote", h = r + 1; h < t && !(e.sCount[h] < _) && (A = e.bMarks[h] + e.tShift[h], w = e.eMarks[h], !(A >= w)); h++)
                    if (62 !== e.src.charCodeAt(A++)) {
                        ...
                        for (c = f = e.sCount[h] + A - (e.bMarks[h] + e.tShift[h]), 32 === e.src.charCodeAt(A) ? (A++, c++, f++, o = !1, v = !0) : 9 === e.src.charCodeAt(A) ? (v = !0, (e.bsCount[h] + f) % 4 === 3 ? (A++, c++, f++, o = !1) : o = !0) : v = !1, d.push(e.bMarks[h]), e.bMarks[h] = A; A < w && (i = e.src.charCodeAt(A), n(i));) 9 === i ? f += 4 - (f + e.bsCount[h] + (o ? 1 : 0)) % 4 : f++, A++;
                        u = A >= w, m.push(e.bsCount[h]), e.bsCount[h] = e.sCount[h] + 1 + (v ? 1 : 0), b.push(e.sCount[h]), e.sCount[h] = f - c, k.push(e.tShift[h]), e.tShift[h] = A - e.bMarks[h]
                    } for (C = e.push("blockquote_open", "blockquote", 1), C.markup = ">", C.map = p = [r, 0], e.md.block.tokenize(e, r, h), C = e.push("blockquote_close", "blockquote", -1), C.markup = ">", e.parentType = g, p[1] = e.line, a = 0; a < k.length; a++) e.bMarks[a + r] = d[a], e.tShift[a + r] = k[a], e.sCount[a + r] = b[a], e.bsCount[a + r] = m[a];
        ...
        25: [function(e, r, t) {
            ...
            r.exports = function(e, r, t, a) {
                var c, l, u, p, h, f, d, m, _, g, b, k, v, y, x, C, A, w, D, q, E, S, F, L, z, T, R, M, I = !1,
                    B = !0;
                if (a && "paragraph" === e.parentType && e.tShift[r] >= e.blkIndent && (I = !0), (F = s(e, r)) >= 0) {
                    if (d = !0, z = e.bMarks[r] + e.tShift[r], v = Number(e.src.substr(z, F - z - 1)), I && 1 !== v) return !1
                } else {
                    if (!((F = n(e, r)) >= 0)) return !1;
                    d = !1
                }
                if (I && e.skipSpaces(F) >= e.eMarks[r]) return !1;
                if (k = e.src.charCodeAt(F - 1), a) return !0;
                for (b = e.tokens.length, d ? (M = e.push("ordered_list_open", "ol", 1), 1 !== v && (M.attrs = [
                        ["start", v]
                    ])) : M = e.push("bullet_list_open", "ul", 1), M.map = g = [r, 0], M.markup = String.fromCharCode(k), x = r, L = !1, R = e.md.block.ruler.getRules("list"), D = e.parentType, e.parentType = "list"; x < t;) {
                    for (S = F, y = e.eMarks[x], f = C = e.sCount[x] + F - (e.bMarks[r] + e.tShift[r]); S < y && (c = e.src.charCodeAt(S), i(c));) 9 === c ? C += 4 - (C + e.bsCount[x]) % 4 : C++, S++;
                    if (l = S, h = l >= y ? 1 : C - f, h > 4 && (h = 1), p = f + h, M = e.push("list_item_open", "li", 1), M.markup = String.fromCharCode(k), M.map = m = [r, 0], A = e.blkIndent, E = e.tight, q = e.tShift[r], w = e.sCount[r], e.blkIndent = p, e.tight = !0, e.tShift[r] = l - e.bMarks[r], e.sCount[r] = C, l >= y && e.isEmpty(r + 1) ? e.line = Math.min(e.line + 2, t) : e.md.block.tokenize(e, r, t, !0), e.tight && !L || (B = !1), L = e.line - r > 1 && e.isEmpty(e.line - 1), e.blkIndent = A, e.tShift[r] = q, e.sCount[r] = w, e.tight = E, M = e.push("list_item_close", "li", -1), M.markup = String.fromCharCode(k), x = r = e.line, m[1] = x, l = e.bMarks[r], x >= t) break;
                    if (e.sCount[x] < e.blkIndent) break;
                    for (T = !1, u = 0, _ = R.length; u < _; u++)
                        if (R[u](e, x, t, !0)) {
                            T = !0;
                            break
                        } if (T) break;
        ...
        27: [function(e, r, t) {
            ...
            r.exports = function(e, r, t, o) {
                var i, a, c, l, u, p, h, f, d, m, _, g, b, k, v, y, x = 0,
                ...
                for (; ++C < A;)
                    ...
                    if (i = b.charCodeAt(C), 91 === i) return !1;
                    if (93 === i) {
                        d = C;
                        break
                    }
                ...
                if (C < A && 10 !== b.charCodeAt(C) && y)
                    for (y = "", C = a, x = c; C < A && (i = b.charCodeAt(C), s(i));) C++;
                return !(C < A && 10 !== b.charCodeAt(C)) && (!!(f = n(b.slice(1, d))) && (!!o || ("undefined" == typeof e.env.references && (e.env.references = {}), "undefined" == typeof e.env.references[f] && (e.env.references[f] = {
                    title: y,
                    href: u
        ...
        29: [function(e, r, t) {
            ...
            r.exports = function(e, r, t, i) {
                ...
                if (l = e.bMarks[p] + e.tShift[p], l >= e.eMarks[p]) return !1;
                if (a = e.src.charCodeAt(l++), 124 !== a && 45 !== a && 58 !== a) return !1;
                for (; l < e.eMarks[p];) {
                    if (a = e.src.charCodeAt(l), 124 !== a && 45 !== a && 58 !== a && !o(a)) return !1;
                    l++
                }
                ...
                if (h = s(c.replace(/^\||\|$/g, "")), f = h.length, f > m.length) return !1;
                if (i) return !0;
                for (d = e.push("table_open", "table", 1), d.map = g = [r, 0], d = e.push("thead_open", "thead", 1), d.map = [r, r + 1], d = e.push("tr_open", "tr", 1), d.map = [r, r + 1], u = 0; u < h.length; u++) d = e.push("th_open", "th", 1), d.map = [r, r + 1], m[u] && (d.attrs = [
                    ["style", "text-align:" + m[u]]
                ]), d = e.push("inline", "", 0), d.content = h[u].trim(), d.map = [r, r + 1], d.children = [], d = e.push("th_close", "th", -1);
                for (d = e.push("tr_close", "tr", -1), d = e.push("thead_close", "thead", -1), d = e.push("tbody_open", "tbody", 1), d.map = b = [r + 2, 0], p = r + 2; p < t && !(e.sCount[p] < e.blkIndent) && (c = n(e, p), c.indexOf("|") !== -1); p++) {
                    for (h = s(c.replace(/^\||\|\s*$/g, "")), d = e.push("tr_open", "tr", 1), u = 0; u < f; u++) d = e.push("td_open", "td", 1), m[u] && (d.attrs = [
                        ["style", "text-align:" + m[u]]
                    ]), d = e.push("inline", "", 0), d.content = h[u] ? h[u].trim() : "", d.children = [], d = e.push("td_close", "td", -1);
        ...
        34: [function(e, r, t) {
            ...
            function s(e) {
                var r, t, s = 0;
                for (r = e.length - 1; r >= 0; r--) t = e[r], "text" !== t.type || s || (t.content = t.content.replace(c, n)), "link_open" === t.type && "auto" === t.info && s--, "link_close" === t.type && "auto" === t.info && s++
            }
        ...
        35: [function(e, r, t) {
            ...
            function s(e, r) {
                var t, s, c, p, h, f, d, m, _, g, b, k, v, y, x, C, A, w, D, q, E;
                for (D = [], t = 0; t < e.length; t++) {
                    ...
                    if (D.length = A + 1, "text" === s.type) {
                        ...
                        e: for (; h < f && (l.lastIndex = h, p = l.exec(c));) {
                            if (x = C = !0, h = p.index + 1, w = "'" === p[0], _ = 32, p.index - 1 >= 0) _ = c.charCodeAt(p.index - 1);
                            else
                                for (A = t - 1; A >= 0; A--)
                                    if ("text" === e[A].type) {
                    ...
                    if (n = o[r], n.close)
                        for (t = r - n.jump - 1; t >= 0;) {
                            if (s = o[t], s.open && s.marker === n.marker && s.end < 0 && s.level === n.level) {
                                var a = (s.close || n.open) && "undefined" != typeof s.length && "undefined" != typeof n.length && (s.length + n.length) % 3 === 0;
                                if (!a) {
        ...
        44: [function(e, r, t) {
            ...
            var n = e("../common/utils").normalizeReference,
                s = e("../common/utils").isSpace;
            r.exports = function(e, r) {
                var t, o, i, a, c, l, u, p, h, f, d, m, _, g = "",
                    b = e.pos,
                    k = e.posMax;
                if (33 !== e.src.charCodeAt(e.pos)) return !1;
                if (91 !== e.src.charCodeAt(e.pos + 1)) return !1;
                if (l = e.pos + 2, c = e.md.helpers.parseLinkLabel(e, e.pos + 1, !1), c < 0) return !1;
                if (u = c + 1, u < k && 40 === e.src.charCodeAt(u)) {
                    ...
                    if (h = e.md.helpers.parseLinkTitle(e.src, u, e.posMax), u < k && _ !== u && h.ok)
                    ...
                    if (u < k && 91 === e.src.charCodeAt(u) ? (_ = u + 1, u = e.md.helpers.parseLinkLabel(e, u), u >= 0 ? a = e.src.slice(_, u++) : u = c + 1) : u = c + 1, a || (a = e.src.slice(l, c)), p = e.env.references[n(a)], !p) return e.pos = b, !1;
                    g = p.href, f = p.title
                }
                return r || (i = e.src.slice(l, c), e.md.inline.parse(i, e.md, e.env, m = []), d = e.push("image", "img", 0), d.attrs = t = [
                    ["src", g],
                    ["alt", ""]
                ], d.children = m, d.content = i, f && t.push(["title", f])), e.pos = u, e.posMax = k, !0
            }
        }, {
            "../common/utils": 4
        }],
        45: [function(e, r, t) {
            ...
            var n = e("../common/utils").normalizeReference,
                s = e("../common/utils").isSpace;
            r.exports = function(e, r) {
                var t, o, i, a, c, l, u, p, h, f, d = "",
                    m = e.pos,
                    _ = e.posMax,
                    g = e.pos,
                    b = !0;
                if (91 !== e.src.charCodeAt(e.pos)) return !1;
                if (c = e.pos + 1, a = e.md.helpers.parseLinkLabel(e, e.pos, !0), a < 0) return !1;
                if (l = a + 1, l < _ && 40 === e.src.charCodeAt(l)) {
                    ...
                    if (u = e.md.helpers.parseLinkTitle(e.src, l, e.posMax), l < _ && g !== l && u.ok)
                ...
                if (b) {
                    if ("undefined" == typeof e.env.references) return !1;
                    if (l < _ && 91 === e.src.charCodeAt(l) ? (g = l + 1, l = e.md.helpers.parseLinkLabel(e, l), l >= 0 ? i = e.src.slice(g, l++) : l = a + 1) : l = a + 1, i || (i = e.src.slice(c, a)), p = e.env.references[n(i)], !p) return e.pos = m, !1;
                    d = p.href, h = p.title
                }
                return r || (e.pos = c, e.posMax = a, f = e.push("link_open", "a", 1), f.attrs = t = [
                    ["href", d]
                ], h && t.push(["title", h]), e.md.inline.tokenize(e), f = e.push("link_close", "a", -1)), e.pos = l, e.posMax = _, !0
            }
        }, {
            "../common/utils": 4
        }],
        ...
        59: [function(e, r, t) {
            ...
            n.prototype.parse = function(e, r) {
                ...
                var b = o.exec(l);
                if (b && (b = b[0], s = b.toLowerCase(), this.protocol = b, l = l.substr(b.length)), (r || b || l.match(/^\/\/[^@\/]+@[^@\/]+/)) && (c = "//" === l.substr(0, 2), !c || b && _[b] || (l = l.substr(2), this.slashes = !0)), !_[b] && (c || b && !g[b])) {
                    var k = -1;
                    for (t = 0; t < h.length; t++) i = l.indexOf(h[t]), i !== -1 && (k === -1 || i < k) && (k = i);
                    var v, y;
                    for (y = k === -1 ? l.lastIndexOf("@") : l.lastIndexOf("@", k), y !== -1 && (v = l.slice(0, y), l = l.slice(y + 1), this.auth = v), k = -1, t = 0; t < p.length; t++) i = l.indexOf(p[t]), i !== -1 && (k === -1 || i < k) && (k = i);
                    k === -1 && (k = l.length), ":" === l[k - 1] && k--;
                    var x = l.slice(0, k);
                    l = l.slice(k), this.parseHost(x), this.hostname = this.hostname || "";
                            ...
                            if (w && !w.match(d)) {
                                ...
                                if (!D.match(d)) {
                                    var S = A.slice(0, t),
                                        F = A.slice(t + 1),
                                        L = w.match(m);
                                    L && (S.push(L[1]), F.unshift(L[2])), F.length && (l = F.join(".") + l), this.hostname = S.join(".");
                                    break
                                }
                            }
                        }
            ...
            (function(r) {
                ! function(s) {
                    ...
                    function f(e) {
                        ...
                        for (s = t > 0 ? t + 1 : 0; s < _;) {
                            for (i = g, a = 1, c = C; s >= _ && o("invalid-input"), p = u(e.charCodeAt(s++)), (p >= C || p > I((x - g) / a)) && o("overflow"), g += p * a, f = c <= k ? A : c >= k + w ? w : c - k, !(p < f); c += C) d = C - f, a > I(x / d) && o("overflow"), a *= d;
                            r = m.length + 1, k = h(g - i, r, 0 == i), I(g / r) > x - b && o("overflow"), b += I(g / r), g %= r, m.splice(g++, 0, b)
                        }
                        return l(m)
                    }
                    ...
                    function d(e) {
                        ...
                        for (n = s = v.length, s && v.push(F); n < _;) {
                            ...
                            for (g = n + 1, l - r > I((x - t) / g) && o("overflow"), t += (l - r) * g, r = l, a = 0; a < _; ++a)
                                if (m = e[a], m < r && ++t > x && o("overflow"), m == r) {
                                    for (u = t, f = C; d = f <= i ? A : f >= i + w ? w : f - i, !(u < d); f += C) k = u - d, b = C - d, v.push(B(p(d + k % b, 0))), u = I(k / b);
                    ...
                    if (v = {
                        ...
                        if (t.exports == g) b.exports = v;
                            ...
                            for (y in v) v.hasOwnProperty(y) && (g[y] = v[y]);
                    else s.punycode = v
                }(this)
